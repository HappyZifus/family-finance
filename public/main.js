...
async function renderIncomeInputs() {
  ...
  let { data: templateData, error: templateErr } = await supabase
  ...
  // 2. Получаем реальные суммы для текущего месяца
